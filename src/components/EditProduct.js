...
const EditProduct = () => {
  ...
  const getProductById = async () => {
    const response = await axios.get(`https://good-rose-centipede-slip.cyclic.app/products/${id}`);
  ...
  const updateProduct = async (e) => {
    ...
    try {
      ...
      await axios.patch(`https://good-rose-centipede-slip.cyclic.app/products/${id}`, formData, {
        headers: {
