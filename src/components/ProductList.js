...
const ProductList = () => {
  ...
  const getProducts = async () => {
    const response = await axios.get("https://good-rose-centipede-slip.cyclic.app/products");
  ...
  const deleteProduct = async (productId) => {
    try {
      await axios.delete(`https://good-rose-centipede-slip.cyclic.app/products/${productId}`);
